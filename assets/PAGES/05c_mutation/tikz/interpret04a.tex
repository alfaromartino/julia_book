...
\node [gray-b] at (8,15.5) {\begin{tabular}{c} $x=[4,5]$;\\ $y=[4,5];$\end{tabular}};



 \draw[-triangle 60]  (9.95,16) -- (11.1,16);
\node[anchor=east,scale=1.2] at (10.15,16) {\begin{tabular}{l} $x$ \end{tabular}}; 

 \draw[-triangle 60]  (9.95,15) -- (11.1,15);
\node[anchor=east,scale=1.2] at (10.15,15) {\begin{tabular}{l} $y$ \end{tabular}}; 

\node [square, anchor=center] at (11.95,16) {\begin{tabular}{c} $[4,5]$\end{tabular}};
\node [square, anchor=center] at (11.95,15) {\begin{tabular}{c} $[4,5]$\end{tabular}};
