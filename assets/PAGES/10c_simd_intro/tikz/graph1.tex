...
\begin{tikzpicture}[
    ...
    % --- TIME AXIS ---
    \draw[->, very thick, gray] (-1, 1) -- (11, 1) node[right] {Time (Sequential Execution)};

    % --- STEP 1 ---
    \node[label] at (0, 0.5) {Step 1};
    ...
    % Annotations
    \node[below=0.5cm of r2] (desc) at (4.5, -4) {4 Instructions, 4 Cycles};
