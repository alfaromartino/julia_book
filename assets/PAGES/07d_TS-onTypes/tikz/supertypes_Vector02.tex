...
\node[otherNode, below right=of abstract, yshift=0cm, xshift=-2.0cm]   (cothers) {$\vdots$};
\node[otherNode, below right=of abstract, yshift=0.0cm, xshift=-1.cm] (cotherss) {$\vdots$};
\node[otherNode, below right=of abstract, yshift=0.0cm, xshift=0.0cm] (cothersss) {$\vdots$};
