...
\draw[myarrow] (any)  -- (othersssss);
    ...
    \node[abstractNode, below=of any, yshift=0cm, xshift=-0.0cm] (number) {Number};
    ...
    \node[concreteNode, below right=of integer, xshift=-0.5cm] (bool) {Bool};
...
\node[otherNode, right=of complex, yshift=0cm, xshift=-0.0cm] (cothers) {...};
\node[otherNode, right=of complex, yshift=0.5cm, xshift=-0.0cm] (cotherss) {...};
\node[otherNode, right=of complex, yshift=1.0cm, xshift=-0.0cm] (cothersss) {...};
\node[otherNode, right=of complex, yshift=-0.5cm, xshift=-0.0cm] (cotherssss) {...};
\node[otherNode, right=of complex, yshift=-1.0cm, xshift=-0.0cm] (cothersssss) {...};
\draw[myarrow] (complex)  -- (cothers);
\draw[myarrow] (complex)  -- (cotherss);
\draw[myarrow] (complex)  -- (cothersss);
\draw[myarrow] (complex)  -- (cotherssss);
\draw[myarrow] (complex)  -- (cothersssss);
