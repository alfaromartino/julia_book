...
\draw[-triangle 60]  (-6.5,6.5) -- node[pos=1, anchor=west] {\textbf{\begin{tabular}{c} \end{tabular}}}(-6.5,-4.5);
%%% thread
\node[blue] (t2) at (-6.5,5) {Thread 1};


\node[square2] at (-6.5,3) {\textbf{\begin{tabular}{c} READ \\ temp = 1 \end{tabular}}};
\node[square2] at (-6.5,1.5) {\textbf{\begin{tabular}{c} WRITE \\ output[1] = 1 \end{tabular}}};


\node[square2] at (-6.5,-1) {\textbf{\begin{tabular}{c} READ \\ temp = 2 \end{tabular}}};
\node[square2] at (-6.5,-2.5) {\textbf{\begin{tabular}{c} WRITE \\ output[2] = 2 \end{tabular}}};

\node[square2] at (-6.5,-6) {\textbf{\begin{tabular}{c} RESULT \\ output = [1,2]\end{tabular}}};
