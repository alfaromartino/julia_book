...
\draw[-triangle 60]  (-1,1) -- node[pos=1, anchor=west] {\textbf{\begin{tabular}{c} \end{tabular}}}(12.5,1);
\draw[-triangle 60]  (-1,-1) -- node[pos=1, anchor=west] {\textbf{\begin{tabular}{c} \end{tabular}}}(12.5,-1);
\draw (-1,1) -- (-1,-1);
...
\node[blue,anchor=east] (t2) at (2.5,1) {Task 1};
