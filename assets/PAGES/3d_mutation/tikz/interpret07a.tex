...
\tikzstyle{red_block}= [draw,outer sep=7,inner sep=3,minimum size=20,line width=1,very thick, draw=red!95, top color=white,bottom color=red!25];
 ...
 \draw[-triangle 60]  (11.95,17) -- (11.3,16);
  \draw[-triangle 60]  (11.95,17) -- (11.95,16);
   \draw[-triangle 60]  (11.95,17) -- (12.6,16);
 


\node [square, anchor=center, scale=2] at (11.95,15.45) {\begin{tabular}{c} $[4,5,6]$\end{tabular}};



\node[anchor=center,scale=1.5] at (11.95,17.25) {\begin{tabular}{l} elements \end{tabular}}; 
