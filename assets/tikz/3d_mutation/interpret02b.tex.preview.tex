%& C:\Users\marti\AppData\Roaming\TikzEdt\TikzEdt\022~1.0\TEMP_H~1
\begin{document}
...
\node [gray-b] at (8,15.5) {\begin{tabular}{c} $x=2$;\\ $y=x;$\\$x=4;$\end{tabular}};

\node [square, anchor=center] at (15.2,15.5) {\begin{tabular}{c} 4\end{tabular}};

 
 \draw[-triangle 60]  (13.4,15.5) -- (14.25,15.5);
\node[anchor=east,scale=1.2] at (13.6,15.5) {\begin{tabular}{l} $x$ \end{tabular}}; 

 \draw[-triangle 60]  (11.9,15.5) -- (12.75,15.5);
\node[anchor=east,scale=1.2] at (12.1,15.5) {\begin{tabular}{l} $y$ \end{tabular}}; 

\node[anchor=center,scale=5.2] at (10.25,15.5) {\begin{tabular}{l} $\Rightarrow$ \end{tabular}}; 
 \draw[very thick]  (9.5,15) -- (11.1,16.2);
